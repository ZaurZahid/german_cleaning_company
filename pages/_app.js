...
const MyApp = ({ Component, pageProps }) => (
  <>
    <Head>
      ...
      <link rel="canonical" href="https://tb-gebaeudereinigung.de" /> {/* need to change */}

      {/* Open Graph (for Facebook, WhatsApp, etc.) */}
      <meta property="og:type" content="website" />
      <meta property="og:title" content="T&B Gebäudereinigung | Professionelle Reinigungsdienste" />
      <meta
      ...
      <meta property="og:url" content="https://tb-gebaeudereinigung.de" /> {/* need to change */}
